            ...
            for key, values in flow_rates_outflow_leak.items():
                    ...
                    if diff_flow < 0.1:
                         ...
                         if (m310_leak > tank_dimensions[tank]):
                              ...
                              negative_outflow_kraken[u] = [pipe_id, tank, tank_dimensions[tank] / 1000, diff_flow, leak_1min, m310_leak, 'tank empty']
                              u = u +1
    
                         else:
                              negative_outflow_kraken[u] = [pipe_id, tank, tank_dimensions[tank] / 1000, diff_flow, leak_1min, m310_leak, '10 cubic meters empty']
                              u = u +1
